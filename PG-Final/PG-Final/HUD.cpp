...
void HUD::Over(std::string pWin, int finalScore) {
	winText = new sf::Text("The Winner Is", font1, 30);
	...
	playerW = new sf::Text(pWin, font1, 25);
	...
	score = new sf::Text(std::to_string(finalScore), font1, 25);
